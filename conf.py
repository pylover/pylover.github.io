...
BLOG_AUTHOR = "Vahid Mardani"  # (translatable)
BLOG_TITLE = "Monty Python & Famous Historian"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://pylover.dobisel.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pylover.dobisel.com/"
BLOG_EMAIL = "vahid@dobisel.com"
BLOG_DESCRIPTION = "Who killed the famous historian in monty python and the holy grail?"  # (translatable)
